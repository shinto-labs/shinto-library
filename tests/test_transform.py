...
from shinto.transform import resolve_source, transform_data
...
class TestCoalesce:
                ...
                "transformations": [
                    {
                        ...
                        "key": "contact_name",
                        "type": "string",
                        "source": {"coalesce": ["preferred_name", "full_name", "email"]},
                    }
                ],
            }
        ]
    ...
    def test_coalesce_skip_empty_string(self):
        ...
        test_data = [
            {"id": "2", "preferred_name": "", "full_name": "Bob Jones", "email": "bob@example.com"}
        ]
    ...
    def test_coalesce_skip_missing_field(self):
        ...
        test_data = [{"id": "3", "full_name": "Charlie Brown", "email": "charlie@example.com"}]
    ...
    def test_coalesce_fallback_to_last(self):
        ...
        test_data = [{"id": "4", "email": "diana@example.com"}]
    ...
    def test_coalesce_skip_none_values(self):
        ...
        test_data = [
            {"id": "5", "preferred_name": None, "full_name": None, "email": "eve@example.com"}
        ]
    ...
    def test_coalesce_all_empty_returns_none(self):
        ...
        test_data = [{"id": "6", "preferred_name": "", "full_name": None}]
                ...
                "transformations": [
                    {
                        ...
                        "key": "final_priority",
                        "type": "int",
                        "source": {"coalesce": ["priority_1", "priority_2", "priority_3"]},
                    }
                ],
            }
        ]
    ...
    def test_resolve_source_coalesce_directly(self):
        ...
        row = {"field1": "", "field2": None, "field3": "value3"}

        source = {"coalesce": ["field1", "field2", "field3"]}
