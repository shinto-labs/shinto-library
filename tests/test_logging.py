import logging
import unittest
from shinto.logging import setup_logging, generate_uvicorn_log_config

# FILEPATH: /home/tommy/work/shintolabs/shinto-library/tests/test_logging.py
...
class TestLogging(unittest.TestCase):
    def test_setup_logging(self):
        ...
        setup_logging(application_name="myapp", loglevel=logging.DEBUG, log_to_stdout=False, log_to_file=True, log_filename="app.log")
    ...
    def test_generate_uvicorn_log_config(self):
        ...
        config = generate_uvicorn_log_config(loglevel=logging.DEBUG, log_to_stdout=False, log_to_file=True, log_to_journald=True, log_filename="app.log")
        self.assertEqual(config["version"], 1)
        self.assertIsInstance(config["loggers"], dict)
