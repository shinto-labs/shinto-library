...
class Connection(psycopg.Connection):
    ...
    def execute_query(self, query: str, params: dict | tuple | list | None = None) -> list[tuple]:
        """
    ...
    def execute_command(
        self, query: str, params: dict | tuple | list | None = None, should_commit: bool = True
    ) -> int:
        """
...
class AsyncConnection(psycopg.AsyncConnection):
    ...
    async def execute_query(
        self, query: str, params: dict | tuple | list | None = None
    ) -> list[tuple]:
        """
